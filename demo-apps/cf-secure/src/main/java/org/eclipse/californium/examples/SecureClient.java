...
public class SecureClient {
	...
	private static final String SERVER_URI = "coaps://192.168.43.77/secure";
	private static final String AlgorithmName = "DTLS-PSK算法";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new JavaApplication().MyDialog(AlgorithmName,loops, TestUtils.getDatagramsPackages(), TestUtils.getRecordNum(), (TestUtils.getEndTime() - TestUtils.getStartTime()));
